...
module.exports = {
    ...
    "JZSNHJSNKQPZZRTFXNChuangHuShiFuKeKaiBi": {
        ...
        "namezh": "窗户是否可开闭",
        'judgeReference':'合理组织室内气流，防止炊事油烟排放造成的室内空气污染和中毒。\n窗按照开启方式分类有有推拉窗、平开窗、固定窗、悬窗、转窗等。窗的开启方式选择常常跟当地的气候特点密切相关。平开窗开启方式简单，安装维修都较为便捷，通风面积在开启几种方式中最大。关闭平开窗时，橡胶密封条受挤压所产生的形变可以使窗紧密封闭，隔音、隔热、保温性能都较好，适宜在严寒地区推广。图75-76',
    },
    ...
    "NYLYTaiYangNenReShuiXiTong": {
        ...
        'judgeReference':'严寒地区普遍日照充足，为太阳能的应用提供了便利的条件，被动式太阳房是将太阳能用于采暖的最简单、最有效的一种形式。被动太阳房无须任何设备，经济成本较低，尤其在部分严寒地区冬季太阳能也较为丰富，只要建筑围护结构进行一定的保温节能改造，被动太阳房完全可以达到室内热环境所要求的基本标准。太阳能低温储水采暖系统也是适合严寒地区村镇的采暖系统之一。图84',
    },
